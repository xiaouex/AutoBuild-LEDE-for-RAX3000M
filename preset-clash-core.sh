...
wget -P feeds/luci/applications/luci-app-openclash/root/etc/openclash/core/ https://raw.githubusercontent.com/vernesong/OpenClash/core/master/meta/clash-linux-arm64.tar.gz
