...
wget  https://raw.githubusercontent.com/vernesong/OpenClash/core/master/meta/clash-linux-arm64.tar.gz -P $core_path && tar -zxvf $core_path/clash-linux-arm64.tar.gz > $core_path/clash_meta
